...
func (wsConn *WSConn) SetPongHandler(h func(appData string) error) {
	wsConn.conn.SetPongHandler(h)
}
func (wsConn *WSConn) SetPingHandler(h func(appData string) error) {
	wsConn.conn.SetPingHandler(h)
}
